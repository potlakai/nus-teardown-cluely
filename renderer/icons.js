// Inlined Lucide icon paths (MIT, lucide.dev) + the Nūs logo mark.
...
(function () {
  ...
  // Nūs logo — the Nūs statue mark (renderer/logo.png), served from the app bundle.
  const LOGO = '<img src="logo.png" width="SIZE" height="SIZE" alt="Nūs" style="border-radius:50%;display:block" />';
